...
//         let fiveDayURL = `api.openweathermap.org/data/2.5/forecast?lat=${lat}&lon=${lon}&appid=${APIKey}&units=imperial`;
//         console.log(fiveDayURL);

//         const nameNode = document.createTextNode(`Location: ${location}, ${weatherDescription}`);
//         city.innerHTML = '';
//         city.appendChild(nameNode);
...
//     today.then(response => response.json())
//     .then(data => {
//     console.log(data);
//     })
// }
